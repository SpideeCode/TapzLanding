      ...
      `}>
                <div className="h-full flex flex-col">
                    ...
                    <div className="p-6 flex items-center justify-between border-b border-gray-50 mb-4">
                        <span className="text-2xl font-black text-[#1E293B] tracking-tight flex items-center gap-2">
                            <Utensils className="text-orange-600" size={24} />
                            <span>Tapzy <span className="text-orange-600">Resto</span></span>
                        </span>
                    ...
                    ${isActive
                                            ? 'bg-orange-600 text-white font-bold shadow-lg shadow-orange-500/30'
            ...
            <div className="flex-1 flex flex-col min-w-0 overflow-hidden">
                ...
                <header className="bg-white border-b px-4 py-4 flex items-center lg:hidden">
                    ...
                    <span className="ml-4 font-bold text-lg">Tapzy Resto</span>
                </header>
